            ...
            {[
              {
                ...
                desc: "State-by-state calculations using real electricity rates, gas prices, and all active incentives.",
                link: "ev",
              },
              {
                icon: <Sun size={24} />,
                title: "Solar ROI Tools",
                desc: "Zip-specific modeling with real utility rates and actual roof considerations. No averages.",
                link: "solar",
              },
              {
                icon: <Star size={24} />,
                title: "Wattfull Score",
                desc: "Our proprietary rating: capacity, value per watt, longevity, and environmental impact.",
                link: "score",
              },
              {
                icon: <TrendingDown size={24} />,
                title: "Price Tracking",
                desc: "Interactive price history with clear 'Best Time to Buy' indicators.",
                link: "prices",
              },
              {
                icon: <MapPin size={24} />,
                title: "State Report Cards",
                desc: "Quarterly grades for EV infrastructure, solar incentives, grid cleanliness, and more.",
                link: "states",
              },
              {
                icon: <Users size={24} />,
                title: "Real-World Data",
                desc: "Crowdsourced solar output, winter EV range, and battery degradation from real owners.",
                link: "community",
              },
            ].map((t, i) => (
              <div
          ...
          >
            ...
            >
              <div style={{ fontSize: 15, fontWeight: 700, color: C.text, marginBottom: 24 }}>
                Cumulative Fuel Costs: EV vs Gas
              </div>
      ...
      <section id="verified" style={{ ...sectionPad, borderTop: `1px solid ${C.border}` }}>
        <div style={containerStyle}>
          <div style={{ maxWidth: 680, margin: "0 auto", textAlign: "center" }}>
            <div style={{ width: 80, height: 80, borderRadius: 20, background: C.greenLight, display: "flex", alignItems: "center", justifyContent: "center", margin: "0 auto 28px" }}>
      ...
      <footer style={{ background: C.bg, borderTop: `1px solid ${C.border}`, padding: "48px 0 36px" }}>
        <div style={containerStyle}>
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(200px, 1fr))", gap: 40, marginBottom: 40 }}>
            ...
            <div>
              <div style={{ fontSize: 12, fontWeight: 600, color: C.textLight, letterSpacing: "0.06em", textTransform: "uppercase", marginBottom: 16 }}>
                Platform
              </div>
            ...
            <div>
              ...
              <p style={{ fontSize: 14, color: C.textMid, marginBottom: 12, lineHeight: 1.5 }}>
                Weekly insights. No spam. Ever.
              </p>
