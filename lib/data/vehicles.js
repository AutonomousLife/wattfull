export const POPULAR_EV_IDS = [
  "model3lr-2025", "modely-2025", "ioniq6rwd-2025", "ioniq5rwd-2025", "ev6rwd-2025",
  "equinoxev-2025", "f150lightning-2025", "id4-2025", "bmwi4-2025", "ev9-2025",
  "cadillaclyriq-2025", "hondaprologue-2025", "rivianr1t-2025", "blazerev-2025", "cybertruck-2025",
];

export const POPULAR_ICE_IDS = [
  "camry-2025", "civic-2025", "corolla-2025", "rav4-2025", "crv-2025",
  "accord-2025", "f150gas-2025", "tacoma-2025", "tucson-2025", "cx5-2025",
  "prius-2025", "highlander-2025", "sorento-2025", "silverado-2025", "4runner-2025",
];
...
const EV_RAW = [
  ...
  // ── Missing 2025 variants ──────────────────────────────────────
  { id:"ioniq5n-2025",   make:"Hyundai", model:"Ioniq 5 N",    trim:"AWD",         year:2025, kwh:31.0, msrp:67950, fc:7500, range:221 },
  { id:"konael-2025",    make:"Hyundai", model:"Kona Electric", trim:"",            year:2025, kwh:27.0, msrp:33550, fc:7500, range:261 },
  { id:"ev6awd-2025",    make:"Kia",     model:"EV6",           trim:"AWD",         year:2025, kwh:30.0, msrp:48600, fc:7500, range:274 },
  { id:"ev6gt-2025",     make:"Kia",     model:"EV6",           trim:"GT",          year:2025, kwh:30.0, msrp:63600, fc:7500, range:206 },
  { id:"ev9awd-2025",    make:"Kia",     model:"EV9",           trim:"AWD",         year:2025, kwh:38.0, msrp:61900, fc:7500, range:280 },
  { id:"mache-2025",     make:"Ford",    model:"Mustang Mach-E",trim:"SR RWD",      year:2025, kwh:30.0, msrp:42995, fc:3750, range:247 },
  { id:"macheawd-2025",  make:"Ford",    model:"Mustang Mach-E",trim:"SR AWD",      year:2025, kwh:34.0, msrp:46000, fc:3750, range:224 },
  { id:"id4awd-2025",    make:"Volkswagen", model:"ID.4",       trim:"AWD",         year:2025, kwh:32.0, msrp:45495, fc:7500, range:255 },
  { id:"bmwi4m50-2025",  make:"BMW",     model:"i4",            trim:"M50",         year:2025, kwh:31.0, msrp:73900, fc:7500, range:270 },
  { id:"bmwix-2025",     make:"BMW",     model:"iX",            trim:"xDrive50",    year:2025, kwh:35.0, msrp:88100, fc:7500, range:324 },
  { id:"nisanariya-2025",make:"Nissan",  model:"Ariya",         trim:"FWD",         year:2025, kwh:30.0, msrp:39125, fc:7500, range:304 },
  { id:"leaf-2025",      make:"Nissan",  model:"LEAF",          trim:"40 kWh",      year:2025, kwh:30.0, msrp:28895, fc:7500, range:149 },
  { id:"subarosolt-2025",make:"Subaru",  model:"Solterra",      trim:"AWD",         year:2025, kwh:31.0, msrp:45995, fc:7500, range:228 },
  { id:"toyotabz4x-2025",make:"Toyota",  model:"bZ4X",          trim:"FWD",         year:2025, kwh:29.0, msrp:44990, fc:7500, range:252 },
  { id:"mercedeseqb-2025",make:"Mercedes-Benz",model:"EQB",trim:"300 4MATIC",      year:2025, kwh:34.0, msrp:55100, fc:7500, range:227 },
  { id:"audiq4-2025",    make:"Audi",    model:"Q4 e-tron",     trim:"RWD",         year:2025, kwh:31.0, msrp:46995, fc:7500, range:265 },
  { id:"gv60-2025",      make:"Genesis", model:"GV60",          trim:"Standard Range",year:2025, kwh:27.0, msrp:42000, fc:7500, range:248 },
  { id:"lucidair-2025",  make:"Lucid",   model:"Air",           trim:"Pure",        year:2025, kwh:23.0, msrp:69900, fc:7500, range:410 },
  { id:"rivianr1s-2025", make:"Rivian",  model:"R1S",           trim:"Dual Motor",  year:2025, kwh:40.0, msrp:78000, fc:7500, range:393 },
  { id:"hummer-2025",    make:"GMC",     model:"Hummer EV",     trim:"3X",          year:2025, kwh:47.0, msrp:89900, fc:7500, range:329 },

  // ── New models ─────────────────────────────────────────────────
  { id:"dodgeev-2024",   make:"Dodge",   model:"Charger Daytona",trim:"Scat Pack",  year:2024, kwh:38.0, msrp:52995, fc:7500, range:318 },
  { id:"dodgeev-2025",   make:"Dodge",   model:"Charger Daytona",trim:"Scat Pack",  year:2025, kwh:38.0, msrp:54995, fc:7500, range:318 },
  { id:"volvex40-2024",  make:"Volvo",   model:"EX40",          trim:"Single Motor",year:2024, kwh:33.0, msrp:54895, fc:7500, range:223 },
  { id:"volvex40-2025",  make:"Volvo",   model:"EX40",          trim:"Single Motor",year:2025, kwh:33.0, msrp:55895, fc:7500, range:223 },
  { id:"porschemacanev-2024",make:"Porsche",model:"Macan",       trim:"Electric",   year:2024, kwh:33.0, msrp:74900, fc:7500, range:288 },
  { id:"porschemacanev-2025",make:"Porsche",model:"Macan",       trim:"Electric",   year:2025, kwh:33.0, msrp:77300, fc:7500, range:288 },
];
...
const ICE_RAW = [
  ...
  // ── 2025 data ──────────────────────────────────────────────────
  { id:"rav4-2025",         make:"Toyota",     model:"RAV4",           trim:"LE",        year:2025, mpg:30, msrp:31975 },
  { id:"rav4hybrid-2025",   make:"Toyota",     model:"RAV4 Hybrid",    trim:"LE",        year:2025, mpg:40, msrp:35725 },
  { id:"highlander-2025",   make:"Toyota",     model:"Highlander",     trim:"L",         year:2025, mpg:24, msrp:40500 },
  { id:"4runner-2025",      make:"Toyota",     model:"4Runner",        trim:"SR5",       year:2025, mpg:18, msrp:43000 },
  { id:"silverado-2025",    make:"Chevrolet",  model:"Silverado 1500", trim:"WT",        year:2025, mpg:19, msrp:39200 },
  { id:"equinoxgas-2025",   make:"Chevrolet",  model:"Equinox",        trim:"LS",        year:2025, mpg:31, msrp:29995 },
  { id:"gmcsierra-2025",    make:"GMC",        model:"Sierra 1500",    trim:"Regular",   year:2025, mpg:18, msrp:42000 },
  { id:"ram1500-2025",      make:"Ram",        model:"1500",           trim:"Tradesman", year:2025, mpg:17, msrp:41500 },
  { id:"altima-2025",       make:"Nissan",     model:"Altima",         trim:"S",         year:2025, mpg:32, msrp:28990 },
  { id:"cx5-2025",          make:"Mazda",      model:"CX-5",           trim:"Sport",     year:2025, mpg:28, msrp:31500 },
  { id:"mazda3-2025",       make:"Mazda",      model:"Mazda3",         trim:"2.5 S",     year:2025, mpg:35, msrp:25200 },
  { id:"sorento-2025",      make:"Kia",        model:"Sorento",        trim:"LX",        year:2025, mpg:27, msrp:33200 },
  { id:"telluride-2025",    make:"Kia",        model:"Telluride",      trim:"LX",        year:2025, mpg:22, msrp:37500 },
  { id:"grandcherokee-2025",make:"Jeep",       model:"Grand Cherokee", trim:"Laredo",    year:2025, mpg:22, msrp:42000 },
  { id:"outback-2025",      make:"Subaru",     model:"Outback",        trim:"Base",      year:2025, mpg:30, msrp:30495 },
  { id:"bmw330i-2025",      make:"BMW",        model:"3 Series",       trim:"330i",      year:2025, mpg:30, msrp:45200 },
  { id:"jetta-2025",        make:"Volkswagen", model:"Jetta",          trim:"S",         year:2025, mpg:34, msrp:23895 },
  { id:"sonata-2025",       make:"Hyundai",    model:"Sonata",         trim:"SE",        year:2025, mpg:35, msrp:26500 },
  { id:"elantra-2025",      make:"Hyundai",    model:"Elantra",        trim:"SE",        year:2025, mpg:37, msrp:22500 },
];
