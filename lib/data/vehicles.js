...
// Derived: sorted descending list of model years present in the catalog
export const VEHICLE_YEARS = [...new Set([...(VEHICLES.ev ?? []), ...(VEHICLES.ice ?? [])].map(v => v.year).filter(Boolean))].sort((a, b) => b - a);
