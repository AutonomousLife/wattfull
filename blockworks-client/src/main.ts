...
ui.setContinue(!!save);
ui.onSettings=()=>void saveSettings(settings);
...
ui.onNewWorld=(name,seedText)=>{const seed=seedFrom(seedText.trim()||String(Date.now()));save=null;ui.setContinue(false);void launch(name,seed);};
